package view.Pages.Settings.DeleteAccount;
...
public class DeleteAccountPanel extends ButtonPanelTemplate implements ActionListener {
    ...
    public DeleteAccountPanel() {
        ...
        label1.setBounds((int) ((mainPanelWidth - label1.getWidth()) / 3.2), mainPanelHeight/4, 200, 50);
    ...
    public void showDeleteAccountPanel(DeleteAccountPanel deleteAccountPanel) {
        ...
        MainPanel.mainPanel.add(deleteAccountPanel);
